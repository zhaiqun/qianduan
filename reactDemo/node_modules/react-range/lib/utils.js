...
function translateThumbs(elements, offsets) {
    elements.forEach(function (element, index) {
        return translate(element, offsets[index].x, offsets[index].y);
    });
}
...
function getTrackBackground(_a) {
    var values = _a.values, colors = _a.colors, min = _a.min, max = _a.max, _b = _a.direction, direction = _b === void 0 ? types_1.Direction.Right : _b;
