...
var Range = /** @class */ (function (_super) {
    ...
    function Range(props) {
        ...
        _this.onWindowResize = function () {
            utils_1.translateThumbs(_this.getThumbs(), _this.getOffsets());
        };
        ...
        _this.onMouseOrTouchStart = function (e) {
            ...
            _this.setState({
                ...
                thumbZIndexes: _this.state.thumbZIndexes.map(function (t, i) {
                    return i === index &&
                        _this.state.thumbZIndexes[i] !== Math.max.apply(Math, _this.state.thumbZIndexes)
                        ? Math.max.apply(Math, _this.state.thumbZIndexes) + 1
                        : _this.state.thumbZIndexes[i];
                })
            });
        };
        ...
        _this.onKeyDown = function (e) {
            var _a = _this.props, values = _a.values, onChange = _a.onChange, step = _a.step;
            ...
            if (['ArrowRight', 'ArrowUp', 'k', 'PageUp'].includes(e.key)) {
                ...
                onChange(utils_1.replaceAt(values, index, _this.normalizeValue(values[index] + (e.key === 'PageUp' ? step * 10 : step), index)));
            }
                ...
                onChange(utils_1.replaceAt(values, index, _this.normalizeValue(values[index] - (e.key === 'PageDown' ? step * 10 : step), index)));
            }
            else if (e.key === 'Tab') {
                _this.setState({ draggedThumbIndex: -1 });
            }
        };
        ...
        _this.onMove = function (clientX, clientY) {
            ...
            var _a = _this.props, direction = _a.direction, min = _a.min, max = _a.max, onChange = _a.onChange, values = _a.values, step = _a.step;
    ...
    Range.prototype.componentDidMount = function () {
        ...
        utils_1.translateThumbs(this.getThumbs(), this.getOffsets());
    };
